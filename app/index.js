...
/* This apps helps you to increase your maximum breath holding time.

--- IMPORTANT NOTES ---

  !!!Important note 1: Health warning!!!
  You use the app and the tables on your own risk! 
  Please be careful when using the tables as to holding your breath 
  ...
  dim mode while the countdown is running. As the whole table might take 20 to 
  30 min this beahviour is consuming battery and might influence your device. 

  - The app requires access to your heart rate sensor 
  - So far its only available for Fitbit IONIC

--- GETTING STARTED ---

  To start the app with or without a fitbit device:
    A very good overview is given here: https://dev.fitbit.com/getting-started/

    In summary you need to do the following:
    - go to https://studio.fitbit.com and create and account
    ...
    - mark all folders (app, companion, resources, settings) and drag and drop them into
      the left menu of the fitbit studio development surface. All folders should now be 
    ...
    - In fitbit.studio use the select Phone and select device menue to select the simulator
    - with the >Run button you build and start the app
    - if you want to run it on your own device:
      - on your phone open the fitbit app
        - go to your device
        - open the developer bridge menue and start the bridge
      - on your device:
        - go to settings 
        - start developer bridge
      - in fitbit.studio select your phone and your device in the top bar select list 
      - in fitbit.studio press >Run
      - the app is now getting installed on your device and is started. You can find it
        there in your normal app menu. 
...
--- FUNCTIONALITIES AND GENERAL DESCRIPTION ---
  ...
  - Start screen
    ...
    - hold breath:
      ...
      right physical button an addtional screen pops up:
        ...
        - save in history:
          ...
          companion is not included yet. With the back button you can get back ot the main
          menu

    - start CO2 table
      When you tap the "start CO2 table" button a new screen opens with mainly three elements
      the top line indicates the time you shall breathe to slow down your pulse and 
      increase your blood O2 level. The blue bar in the back is a visual indicator for the countdown. 
      When 10s or 5s remain the device is vibrating.
      ...
      blue circle on the lower half of the screen. 
      ...
      The CO2 table is calcualted in the following way:
    ...
    - start O2 table
      display comparable to the CO2 table countdown

      The O2 table is calcualted in the following way:
